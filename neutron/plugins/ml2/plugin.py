...
class Ml2Plugin(db_base_plugin_v2.NeutronDbPluginV2,
                ...
                physicalport_db.PhysicalPortDbMixin):
    ...
    def update_physical_port(self, context, id, physical_port):
        ...
        updated_physical_port = super(Ml2Plugin, self).update_physical_port(
                                         context, id, physical_port)
        return updated_physical_port
    ...
    def delete_physical_port(self, context, id):
        ...
        super(Ml2Plugin, self).delete_physical_port(context, id)
