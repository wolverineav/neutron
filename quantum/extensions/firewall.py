...
fw_valid_protocol_values = [None, 'tcp', 'udp', 'icmp']
fw_valid_action_values = ['allow', 'deny']
...
def convert_action_to_case_insensitive(value):
    ...
    try:
        ...
        raise FirewallRuleInvalidAction(
            protocol=value, values=fw_valid_action_values)
...
RESOURCE_ATTRIBUTE_MAP = {
    ...
    'firewall_policies': {
        ...
        'firewalls_list': {'allow_post': False, 'allow_put': False,
                           'convert_to': attr.convert_none_to_empty_list,
                           'default': [], 'is_visible': True},
